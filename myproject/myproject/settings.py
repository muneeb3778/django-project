...
SECRET_KEY = 'django-insecure-n^*_x)5c^$@tg$20#lr82d46&i(kgh*47=x!5)4d_ik=!ep&ko'
...
# additional add for connect react to django

CORS_ORIGIN_ALLOW_ALL = False  # Or True if you want to allow all origins
